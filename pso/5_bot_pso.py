...
def pso_thread():
	...
	while(count>0) :
		...
		count = count -1
		# input()
		t1 = threading.Thread(target=bot1, args=(clientID, a_next))
		t2 = threading.Thread(target=bot2, args=(clientID, b_next))
		t3 = threading.Thread(target=bot3, args=(clientID, c_next))
		t4 = threading.Thread(target=bot4, args=(clientID, d_next))
		t5 = threading.Thread(target=bot5, args=(clientID, e_next))
		t1.start()
		t2.start()
		t3.start()
		t4.start()
...
if __name__ == "__main__": 
	...
	t1 = threading.Thread(target=bot1, args=(clientID, [5,5]))
	t2 = threading.Thread(target=bot2, args=(clientID, [5,5]))
	t3 = threading.Thread(target=bot3, args=(clientID, [5,5]))
	t4 = threading.Thread(target=bot4, args=(clientID, [5,5]))
	t5 = threading.Thread(target=bot5, args=(clientID, [5,5]))
